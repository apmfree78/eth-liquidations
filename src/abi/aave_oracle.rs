...
pub mod aave_oracle {
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            events: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Event {
                        name: ::std::borrow::ToOwned::to_owned("FallbackOracleUpdated",),
    ...
    pub static AAVE_ORACLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct AAVE_ORACLE<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for AAVE_ORACLE<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for AAVE_ORACLE<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for AAVE_ORACLE<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for AAVE_ORACLE<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AAVE_ORACLE))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AAVE_ORACLE<M> {
        ...
        pub fn asset_source_updated_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, AssetSourceUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn base_currency_set_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BaseCurrencySetFilter>
        {
            self.0.event()
        }
        ...
        pub fn fallback_oracle_updated_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, FallbackOracleUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, AAVE_ORACLEEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for AAVE_ORACLE<M> {
    ...
    impl ::ethers::contract::EthLogDecode for AAVE_ORACLEEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AssetSourceUpdatedFilter::decode_log(log) {
                return Ok(AAVE_ORACLEEvents::AssetSourceUpdatedFilter(decoded));
            }
            if let Ok(decoded) = BaseCurrencySetFilter::decode_log(log) {
                return Ok(AAVE_ORACLEEvents::BaseCurrencySetFilter(decoded));
            }
            if let Ok(decoded) = FallbackOracleUpdatedFilter::decode_log(log) {
                return Ok(AAVE_ORACLEEvents::FallbackOracleUpdatedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for AAVE_ORACLEEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AssetSourceUpdatedFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::BaseCurrencySetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::FallbackOracleUpdatedFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<AssetSourceUpdatedFilter> for AAVE_ORACLEEvents {
        fn from(value: AssetSourceUpdatedFilter) -> Self {
            Self::AssetSourceUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<BaseCurrencySetFilter> for AAVE_ORACLEEvents {
        fn from(value: BaseCurrencySetFilter) -> Self {
            Self::BaseCurrencySetFilter(value)
        }
    }
    impl ::core::convert::From<FallbackOracleUpdatedFilter> for AAVE_ORACLEEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for AAVE_ORACLECalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <BaseCurrencyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::BaseCurrency(decoded));
            }
            if let Ok(decoded) =
                <BaseCurrencyUnitCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::BaseCurrencyUnit(decoded));
            }
            if let Ok(decoded) = <GetAssetPriceCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetFallbackOracleCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetFallbackOracle(decoded));
            }
            if let Ok(decoded) =
                <GetSourceOfAssetCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SetFallbackOracleCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for AAVE_ORACLECalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::AddressesProvider(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::BaseCurrency(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::BaseCurrencyUnit(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetAssetPrice(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetAssetsPrices(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetFallbackOracle(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetSourceOfAsset(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetAssetSources(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SetFallbackOracle(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
    impl ::core::fmt::Display for AAVE_ORACLECalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddressesProviderCall> for AAVE_ORACLECalls {
        fn from(value: AddressesProviderCall) -> Self {
            Self::AddressesProvider(value)
        }
    }
    impl ::core::convert::From<BaseCurrencyCall> for AAVE_ORACLECalls {
        fn from(value: BaseCurrencyCall) -> Self {
            Self::BaseCurrency(value)
        }
    }
    impl ::core::convert::From<BaseCurrencyUnitCall> for AAVE_ORACLECalls {
        fn from(value: BaseCurrencyUnitCall) -> Self {
            Self::BaseCurrencyUnit(value)
        }
    }
    impl ::core::convert::From<GetAssetPriceCall> for AAVE_ORACLECalls {
        fn from(value: GetAssetPriceCall) -> Self {
            Self::GetAssetPrice(value)
        }
    }
    impl ::core::convert::From<GetAssetsPricesCall> for AAVE_ORACLECalls {
        fn from(value: GetAssetsPricesCall) -> Self {
            Self::GetAssetsPrices(value)
        }
    }
    impl ::core::convert::From<GetFallbackOracleCall> for AAVE_ORACLECalls {
        fn from(value: GetFallbackOracleCall) -> Self {
            Self::GetFallbackOracle(value)
        }
    }
    impl ::core::convert::From<GetSourceOfAssetCall> for AAVE_ORACLECalls {
        fn from(value: GetSourceOfAssetCall) -> Self {
            Self::GetSourceOfAsset(value)
        }
    }
    impl ::core::convert::From<SetAssetSourcesCall> for AAVE_ORACLECalls {
        fn from(value: SetAssetSourcesCall) -> Self {
            Self::SetAssetSources(value)
        }
    }
    impl ::core::convert::From<SetFallbackOracleCall> for AAVE_ORACLECalls {
