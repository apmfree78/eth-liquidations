...
pub mod liquidate_qualified_user {
    const _: () = {
        ::core::include_bytes!(
            "/Users/apmfree/Desktop/rust/learn_ethers/examples/abi/LiquidateQualifiedUser.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static LIQUIDATE_QUALIFIED_USER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static LIQUIDATE_QUALIFIED_USER_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static LIQUIDATE_QUALIFIED_USER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::core::abi::AbiDecode for LIQUIDATE_QUALIFIED_USERErrors {
        fn decode(
            ...
            if let Ok(decoded) = <InsufficientBalanceToPayLoan as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::InsufficientBalanceToPayLoan(decoded));
            }
            if let Ok(decoded) = <NoCollateralToken as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NoCollateralToken(decoded));
            }
            if let Ok(decoded) = <NoUserAccountQualifiedForLiquidation as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NoUserAccountQualifiedForLiquidation(decoded));
            }
            if let Ok(decoded) = <NotEnoughDebtTokenToCoverLiquidation as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for LIQUIDATE_QUALIFIED_USERErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::NoCollateralToken(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<InsufficientBalanceToPayLoan>
    for LIQUIDATE_QUALIFIED_USERErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for LIQUIDATE_QUALIFIED_USERCalls {
        fn decode(
            ...
            if let Ok(decoded) = <LiquidateAccountCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
