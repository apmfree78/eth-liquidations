...
pub mod liquidate_user {
    ...
    pub static LIQUIDATE_USER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    ...
    pub static LIQUIDATE_USER_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static LIQUIDATE_USER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::core::abi::AbiDecode for LIQUIDATE_USERCalls {
        fn decode(
            ...
            if let Ok(decoded) = <FindAndLiquidateAccountCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
