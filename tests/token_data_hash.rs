use eth_liquadation::data::token_data_hash::get_and_save_erc20_by_token_address;
use eth_liquadation::data::{erc20::Erc20Token, token_data_hash::get_token_data};
use ethers::providers::{Provider, Ws};
use std::sync::Arc;

#[tokio::test]
async fn get_and_save_token_method_is_valid() -> Result<(), Box<dyn std::error::Error>> {
